...
public class NotesView extends JPanel {
	...
	public NotesView(int projectIndex, int activityIndex, Client client){
		...
		project = client.getCollaborationProject().get(projectIndex);		
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!input.equals("")){
					try {
						...
						w.setVisible(false);									
						NotesView newNotesView = null;
						newNotesView = new NotesView(projectIndex, activityIndex, client);
